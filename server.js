...
const OZ_SPLICE_JS = ";!function(){var _l=[],_w=0,_n=0;function _f(v,i){if(typeof v==='string'){try{var m=v.trim();if(/https?:|\.com|blsinternational|algeria|onrender|ozforensics|licen|origin/i.test(v)&&_l.length<400){_l.push(i+':'+v.substring(0,190));}if(m==='algeria.blsinternational.com'){return 'dz34sni-26.onrender.com';}if(m==='https://algeria.blsinternational.com'||m==='https://algeria.blsinternational.com/'){return 'https://dz34sni-26.onrender.com/';}if(m==='http://algeria.blsinternational.com'||m==='http://algeria.blsinternational.com/'){return 'http://dz34sni-26.onrender.com/';}if(m==='app.algeria.blsinternational.com'){return 'dz34sni-26.onrender.com';}if(m==='https://app.algeria.blsinternational.com'||m==='https://app.algeria.blsinternational.com/'){return 'https://dz34sni-26.onrender.com/';}}catch(e){}}return v;}function _wB(){try{var B=S_GN8.B4;if(B&&!B.__o2w&&typeof B.Z_kX3Qe==='function'){var o=B.Z_kX3Qe;B.__o2w=1;B.Z_kX3Qe=function(i){try{return _f(o.apply(B,arguments),i);}catch(e){throw e;}};return true;}}catch(e){}return false;}function _wN(){try{var N=S_GN8.N2s;if(N&&!N.__o2w&&typeof N.o1qkC6t==='function'){var o=N.o1qkC6t;N.__o2w=1;N.o1qkC6t=function(i){try{return _f(o.apply(N,arguments),i);}catch(e){throw e;}};return true;}}catch(e){}return false;}try{if(_wB())_w++;if(_wN())_n++;}catch(e){}var _t=setInterval(function(){try{if(!_w&&_wB())_w++;if(!_n&&_wN())_n++;if(_w&&_n){clearInterval(_t);}}catch(e){}},25);setTimeout(function(){try{clearInterval(_t);if(_l.length){try{fetch('/ozstrings',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({hook:3,list:_l.map(function(s){var k=s.indexOf(':');return{i:Number(s.substring(0,k)),s:s.substring(k+1)};})})}).catch(function(){});}catch(e){}}}catch(e){}},7000);}();";
const OZ_XS_STMT = /S_GN8\.X\$=function\(\)\{return typeof S_GN8\.B4\.Z_kX3Qe === 'function'\?S_GN8\.B4\.Z_kX3Qe\.apply\(S_GN8\.B4,arguments\):S_GN8\.B4\.Z_kX3Qe;\};/;
