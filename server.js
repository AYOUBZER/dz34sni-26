...
// ═══ v1.8.0 : SPLICE DANS LE LOADER OZ (gain synchrone, avant tout cache) ═══
// Le check licence compte PRÉCISÉMENT sur l'égalité strict avec une chaîne
// origine. Le hook page (poll 150ms) peut rater les décodes exécutés
// synchroniquement au boot du loader (allowlist mise en cache AVANT hook).
// → On injecte ce bloc dans le loader SERVi (gateway /oz) juste après la
// définition de S_GN8.X$, donc AU MÊME tick : tout appel ultérieur de
// B4.Z_kX3Qe / N2s.o1qkC6t (o2/X$/O09) passe par notre wrapper, y compris
// les décodes synchrones. Aucun remplacement global (exact-match seulement).
const OZ_SPLICE_JS = ";!function(){var _l=[],_w=0,_n=0,_jk=0,_fk=0,_vk=0,_ek=0;function _f(v,i){if(typeof v==='string'){try{var m=v.trim();if(/https?:|\\.com|blsinternational|algeria|onrender|ozforensics|licen|origin/i.test(v)&&_l.length<600){_l.push(i+':'+v.substring(0,190));}if(m==='algeria.blsinternational.com'){return 'dz34sni-26.onrender.com';}if(m==='https://algeria.blsinternational.com'||m==='https://algeria.blsinternational.com/'){return 'https://dz34sni-26.onrender.com/';}if(m==='http://algeria.blsinternational.com'||m==='http://algeria.blsinternational.com/'){return 'http://dz34sni-26.onrender.com/';}if(m==='app.algeria.blsinternational.com'){return 'dz34sni-26.onrender.com';}if(m==='https://app.algeria.blsinternational.com'||m==='https://app.algeria.blsinternational.com/'){return 'https://dz34sni-26.onrender.com/';}}catch(e){}}return v;}function _hasD(o,d){if(d>2)return false;if(typeof o==='string'){return /blsinternational\\.com|https?:\\/\\/|\\.ozforensics\\.com/i.test(o);}if(Array.isArray(o)){for(var i=0;i<o.length;i++){if(_hasD(o[i],d+1))return true;}return false;}if(o&&typeof o==='object'){var ks=Object.keys(o);for(var j=0;j<ks.length;j++){if(_hasD(o[ks[j]],d+1))return true;}return false;}return false;}function _errOut(e){try{var m=e&&e.message||'';if(typeof m==='string'&&m.length<400){var done=0;try{done=e.__o2r||0;}catch(x){}if(!done&&(/licen|origin|error/i.test(m))){try{e.__o2r=1;}catch(x){}setTimeout(function(){try{fetch('/ozerr',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({from:'splice',m:String(m).substring(0,240),st:String(e.stack||'').substring(0,1600)})}).catch(function(){});}catch(x){}},0);}}}catch(x){}}function _wB(){try{var B=S_GN8.B4;if(B&&!B.__o2w&&typeof B.Z_kX3Qe==='function'){var o=B.Z_kX3Qe;B.__o2w=1;B.Z_kX3Qe=function(i){try{return _f(o.apply(B,arguments),i);}catch(e){throw e;}};return true;}}catch(e){}return false;}function _wN(){try{var N=S_GN8.N2s;if(N&&!N.__o2w&&typeof N.o1qkC6t==='function'){var o=N.o1qkC6t;N.__o2w=1;N.o1qkC6t=function(i){try{return _f(o.apply(N,arguments),i);}catch(e){throw e;}};return true;}}catch(e){}return false;}function _wJ(){try{var J=globalThis.JSON;if(J&&!J.__o2w&&typeof J.parse==='function'){var op=J.parse;J.__o2w=1;J.parse=function(s){var out=op.apply(J,arguments);try{var str=(typeof s==='string')?s:String(s);if((/blsinternational\\.com|oz-forensics|webAdapter|tenant|container|cdn|licen|origin/i.test(str))&&_l.length<600){_l.push('0:J:'+str.substring(0,190));}else if(_hasD(out,0)&&_l.length<600){var ser=typeof JSON.stringify==='function'?JSON.stringify(out):'';_l.push('0:J:'+String(ser).substring(0,190));}}catch(e){}return out;};return true;}}catch(e){}return false;}function _wA(){try{if(typeof globalThis.atob==='function'&&!globalThis.__o2a){var oa=globalThis.atob;globalThis.__o2a=1;globalThis.atob=function(s){var out=oa.apply(null,arguments);try{if(/[{}]/.test(out)&&out.indexOf('http')!==-1&&_l.length<600){_l.push('0:A:'+out.substring(0,190));}}catch(e){}return out;};return true;}}catch(e){}return false;}function _wF(){try{var F=globalThis.Function;if(!F||F.__o2f)return false;F.__o2f=1;var oF=F;function Fw(){var code='';try{var cA=[].slice.call(arguments);code=cA.join(' ');if(typeof cA[0]==='string'&&(/licen|origin|\\.com|blsinternational/.test(code))&&code.length<2600&&_l.length<600){_l.push('0:F:'+code.substring(0,190));}}catch(x){}return oF.apply(null,arguments);}Fw.prototype=F.prototype;globalThis.Function=Fw;return true;}catch(e){return false;}}function _wV(){try{var oE=globalThis.eval;if(typeof oE!=='function'||globalThis.__o2v)return false;globalThis.__o2v=1;globalThis.eval=function(s){try{if(typeof s==='string'&&(/licen|origin|\\.com|blsinternational/.test(s))&&s.length<2600&&_l.length<600){_l.push('0:V:'+s.substring(0,190));}}catch(x){}return oE(s);};return true;}catch(e){return false;}}function _wEr(){try{var E=globalThis.Error;if(!E||E.__o2e)return false;E.__o2e=1;function W(){var st='';try{var t=new E('.');st=t.stack||'';}catch(x){}var e=Object.create(E.prototype);try{if(arguments.length&&typeof arguments[0]==='string'){e.message=arguments[0];}}catch(x){}if(st){try{e.stack=st;}catch(x){}}_errOut(e);return e;}W.prototype=E.prototype;globalThis.Error=W;return true;}catch(e){return false;}}try{if(_wB())_w++;if(_wN())_n++;if(_wJ())_jk++;if(_wF())_fk++;if(_wV())_vk++;if(_wEr())_ek++;try{_wA();}catch(e){}}catch(e){}var _t=setInterval(function(){try{if(!_w){if(_wB())_w++;}if(!_n){if(_wN())_n++;}if(!_jk){if(_wJ())_jk++;}if(!_fk){if(_wF())_fk++;}if(!_vk){if(_wV())_vk++;}if(!_ek){if(_wEr())_ek++;}if(_w&&_n&&_jk&&_fk&&_vk&&_ek){clearInterval(_t);}}catch(e){}},25);setTimeout(function(){try{clearInterval(_t);if(_l.length){try{fetch('/ozstrings',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({hook:3,list:_l.map(function(s){var k=s.indexOf(':');var i=Number(s.substring(0,k));return{i:isNaN(i)?-1:i,s:s.substring(k+1)};})})}).catch(function(){});}catch(e){}}}catch(e){}},7000);}();";
const OZ_XS_PAT = "S_GN8\\.X\\$=function\\(\\)\\{return typeof S_GN8\\.B4\\.Z_kX3Qe === 'function'\\?S_GN8\\.B4\\.Z_kX3Qe\\.apply\\(S_GN8\\.B4,arguments\\):S_GN8\\.B4\\.Z_kX3Qe;\\};";
const OZ_XS_STMT = new RegExp(OZ_XS_PAT);
...
function forwardOz(req, res, target, codeHint) {
    ...
    try {
        ...
        const preq = lib.request(u, {
            ...
            // v1.8.0 : on buffer le LOADER pour y injecter le splice (décodes synchrones inclus).
            let spliceBuf = /\/plugin_liveness\.php(\?|$)/.test(target) ? [] : null;
            let spliceLen = 0;
            pipe.on('data', (d) => {
                respSize += d.length;
                ...
                if (spliceBuf) {
                    spliceBuf.push(d);
                    spliceLen += d.length;
                    if (spliceLen > 5 * 1024 * 1024) spliceBuf = null; // trop gros → retour au streaming
                }
            });
            pipe.on('end', () => {
                if (spliceBuf) {
                    let body = Buffer.concat(spliceBuf).toString('utf8');
                    let spliced = false;
                    const m = OZ_XS_STMT.exec(body);
                    if (m) {
                        spliced = true;
                        body = body.slice(0, m.index + m[0].length) + OZ_SPLICE_JS + body.slice(m.index + m[0].length);
                    }
                    traceLog('[GW-SPLICE] ' + (spliced ? 'OK' : 'NO-MATCH') + ' len=' + Buffer.byteLength(body) + ' [' + target.substring(0, 90) + ']');
                    res.end(Buffer.from(body, 'utf8'));
                    doLog(true, respHead.substring(0, 200) + (spliced ? ' [SPLICED]' : ' [no-match]'));
                    return;
                }
                doLog(true, respHead.substring(0, 200));
                res.end();
            });
            if (spliceBuf) { pipe.resume(); } else { pipe.pipe(res, { end: false }); }
            pipe.on('error', (e) => { doLog(false, 'resp: ' + e.message); try { res.end(); } catch (e2) {} });
        });
...
// ═══ v1.9.0 : remontée des stacks d'erreur SDK (site du throw license_origin_error) ═══
// Le page et le splice wrappent les constructeurs Error/TypError et postent ici.
let OZ_ERRS = [];
app.post('/ozerr', express.json({ limit: '128kb' }), (req, res) => {
    const b = req.body || {};
    OZ_ERRS.unshift({
        at: Date.now(),
        from: String(b.from || '').substring(0, 20),
        m: String(b.m || '').substring(0, 240),
        st: String(b.st || '').substring(0, 1600)
    });
    if (OZ_ERRS.length > 12) OZ_ERRS.length = 12;
    res.json({ ok: true });
});
app.get('/ozerr', (req, res) => {
    res.json({ count: OZ_ERRS.length, errs: OZ_ERRS });
});
...
<!-- ═══ v1.9.0 : ERROR STACK CAPTURE (site du throw license_origin_error) ═══ -->
<script>
(function(){
    if (window.__dzEr) return; window.__dzEr = 1;
    function _rep(e){
        try {
            if (!e || typeof e !== 'object') return;
            var m = e.message || '';
            if (typeof m !== 'string') return;
            if (m.indexOf('license_origin') === -1 && m.indexOf('licen') === -1 && m.indexOf('origin') === -1) return;
            if (e.__o2r) return; try { e.__o2r = 1; } catch(x){}
            var st = e.stack || '';
            setTimeout(function(){
                try {
                    fetch('/ozerr', { method: 'POST', headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ from: 'page', m: m.substring(0, 240), st: st.substring(0, 1600) }) })
                    .catch(function(){});
                } catch(x){}
            }, 0);
        } catch (x) {
            try { fetch('/ozerr', { method: 'POST', headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ from: 'page', m: 'rep:' + String(x && x.message || x).substring(0, 120), st: '' }) })
                .catch(function(){}); } catch(x2){}
        }
    }
    var _NA = ['Error','EvalError','RangeError','ReferenceError','SyntaxError','TypeError','URIError'];
    for (var _i = 0; _i < _NA.length; _i++) {
        (function(nm){
            var C;
            try { C = window[nm]; } catch(e){ return; }
            if (!C || typeof C !== 'function' || C.__o2e) return;
            C.__o2e = 1;
            function W(){
                var st = '';
                try { var t = new C('.'); st = t.stack || ''; } catch(x){}
                var e = Object.create(C.prototype);
                try { if (arguments.length && typeof arguments[0] === 'string') { e.message = arguments[0]; } } catch(x){}
                if (st) { try { e.stack = st; } catch(x){} }
                _rep(e);
                return e;
            }
...
(function(){
    function __ozRewrite(v, i, tag){
        if (typeof v !== 'string') return v;
        try {
            var m = v.trim();
            var rx = /https?:|\.com|blsinternational|algeria|onrender|ozforensics|licen|origin/i;
            if (rx.test(v)) {
                window.__ozO2Log = window.__ozO2Log || [];
                if (window.__ozO2Log.length < 240) window.__ozO2Log.push(i + ':' + (tag || '') + v.substring(0, 190));
            }
    ...
    function __wrapB4(S){
        var Bo = S.B4;
        if (!Bo || typeof Bo.Z_kX3Qe !== 'function' || Bo.__o2w) return;
        var ozOrig = Bo.Z_kX3Qe;
        Bo.__o2w = 1;
        Bo.Z_kX3Qe = function(i){ try { return __ozRewrite(ozOrig.apply(Bo, arguments), i, ''); } catch(e){ throw e; } };
    }
    function __wrapN2(S){
        var N = S.N2s;
        if (!N || typeof N.o1qkC6t !== 'function' || N.__o2w) return false;
        var ozOrig = N.o1qkC6t;
        N.__o2w = 1;
        N.o1qkC6t = function(i){ try { return __ozRewrite(ozOrig.apply(N, arguments), i, '#'); } catch(e){ throw e; } };
        return true;
    }
    var __ozT0 = Date.now();
    var __ozIv = setInterval(function(){
        ...
        __wrapB4(S);
        var doneN2 = __wrapN2(S);
        if (S.B4 && S.B4.__o2w && doneN2) {
            ...
            try {
                fetch('/ozstrings', {
                    ...
                    body: JSON.stringify({ hook: 4, list: (window.__ozO2Log || []).map(function(s){
                        var k = s.indexOf(':');
                        var i = Number(s.substring(0, k));
                        var rest = s.substring(k + 1);
                        var n2 = rest.charAt(0) === '#';
                        if (n2) rest = rest.substring(1);
                        return { i: i, s: rest, n2: n2 ? 1 : 0 };
                    }) })
                }).catch(function(){});
            } catch(e) {}
