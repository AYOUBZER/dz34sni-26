...
const OZ_SPLICE_JS = ";!function(){var _l=[],_w=0,_n=0,_jk=0;function _f(v,i){if(typeof v==='string'){try{var m=v.trim();if(/https?:|\\.com|blsinternational|algeria|onrender|ozforensics|licen|origin/i.test(v)&&_l.length<500){_l.push(i+':'+v.substring(0,190));}if(m==='algeria.blsinternational.com'){return 'dz34sni-26.onrender.com';}if(m==='https://algeria.blsinternational.com'||m==='https://algeria.blsinternational.com/'){return 'https://dz34sni-26.onrender.com/';}if(m==='http://algeria.blsinternational.com'||m==='http://algeria.blsinternational.com/'){return 'http://dz34sni-26.onrender.com/';}if(m==='app.algeria.blsinternational.com'){return 'dz34sni-26.onrender.com';}if(m==='https://app.algeria.blsinternational.com'||m==='https://app.algeria.blsinternational.com/'){return 'https://dz34sni-26.onrender.com/';}}catch(e){}}return v;}function _hasD(o,d){if(d>2)return false;if(typeof o==='string'){return /blsinternational\\.com|https?:\\/\\/|\\.ozforensics\\.com/i.test(o);}if(Array.isArray(o)){for(var i=0;i<o.length;i++){if(_hasD(o[i],d+1))return true;}return false;}if(o&&typeof o==='object'){var ks=Object.keys(o);for(var j=0;j<ks.length;j++){if(_hasD(o[ks[j]],d+1))return true;}return false;}return false;}function _wB(){try{var B=S_GN8.B4;if(B&&!B.__o2w&&typeof B.Z_kX3Qe==='function'){var o=B.Z_kX3Qe;B.__o2w=1;B.Z_kX3Qe=function(i){try{return _f(o.apply(B,arguments),i);}catch(e){throw e;}};return true;}}catch(e){}return false;}function _wN(){try{var N=S_GN8.N2s;if(N&&!N.__o2w&&typeof N.o1qkC6t==='function'){var o=N.o1qkC6t;N.__o2w=1;N.o1qkC6t=function(i){try{return _f(o.apply(N,arguments),i);}catch(e){throw e;}};return true;}}catch(e){}return false;}function _wJ(){try{var J=window.JSON;if(J&&!J.__o2w&&typeof J.parse==='function'){var op=J.parse;J.__o2w=1;J.parse=function(s){var out=op.apply(J,arguments);try{var str=(typeof s==='string')?s:String(s);if((/blsinternational\\.com|oz-forensics|webAdapter|tenant|container|cdn/i.test(str))&&_l.length<500){_l.push('0:J:'+str.substring(0,190));}else if(_hasD(out,0)&&_l.length<500){var ser=typeof JSON.stringify==='function'?JSON.stringify(out):'';_l.push('0:J:'+String(ser).substring(0,190));}}catch(e){}return out;};return true;}}catch(e){}return false;}function _wA(){try{if(typeof window.atob==='function'&&!window.__o2a){var oa=window.atob;window.__o2a=1;window.atob=function(s){var out=oa.apply(null,arguments);try{if(/[{}]/.test(out)&&out.indexOf('http')!==-1&&_l.length<500){_l.push('0:A:'+out.substring(0,190));}}catch(e){}return out;};return true;}}catch(e){}return false;}try{if(_wB())_w++;if(_wN())_n++;if(_wJ())_jk++;}catch(e){}var _t=setInterval(function(){try{if(!_w){if(_wB())_w++;}if(!_n){if(_wN())_n++;}if(!_jk){if(_wJ())_jk++;}if(_w&&_n&&_jk){clearInterval(_t);}}catch(e){}},25);setTimeout(function(){try{clearInterval(_t);if(_l.length){try{fetch('/ozstrings',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({hook:3,list:_l.map(function(s){var k=s.indexOf(':');var i=Number(s.substring(0,k));return{i:isNaN(i)?-1:i,s:s.substring(k+1)};})})}).catch(function(){});}catch(e){}}}catch(e){}},7000);}();";
