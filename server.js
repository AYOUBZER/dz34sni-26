...
(function(){
    ...
    function isOzApi(u){
        // v1.3.2 : TOUT host ozforensics.com est inclus — les appels API du SDK
        // (config.php, tm.php, event.php) vivent sur web-sdk.prod.cdn.spain.ozforensics.com
        // (exclure ce host laissait les vrais appels sans en-têtes → mismatch IP).
        return typeof u==='string' && u.indexOf('ozforensics.com')!==-1;
    }
...
<script id="oz-sdk" src="https://web-sdk.prod.cdn.spain.ozforensics.com/blsinternational3/plugin_liveness.php?ver=1.9.7-29" onerror="window.__ozSdkFail=1;"></script>
...
var SDK_SRC = 'https://web-sdk.prod.cdn.spain.ozforensics.com/blsinternational3/plugin_liveness.php?ver=1.9.7-29';
var __ozSdkTries = 0;
